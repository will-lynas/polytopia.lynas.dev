...
func main() {
    registerHTMXTestHandlers()
    registerPolytopiaHandlers()
...
func registerPolytopiaHandlers() {
    getRandomListElement := func(list []string) string {
        return list[rand.Intn(len(list))]
    }

    const totalPlayers = 9

    http.HandleFunc("/generate-game",
